...
namespace FalconUDP
{
    ...
    public enum SendOptions : byte
    {
        ...
        /// <summary>
        /// Garantees packet when received by remote peer is proccessed in-order in relation to 
        ...
        /// <summary>
        /// Garantees arrival (<see cref="Reliable"/>) and is processed in-order in relation to 
        /// other packets sent using this, and only this, SendOption.
        /// </summary>
        /// <remarks>Using this options garantees all packets are received and proccessed in-order. 
        /// However this involves more overhead: bandwidth because of the ACKs and memory as peers 
        /// have to hold on to sent packets until they ACKnowledged, in case they are not and need 
        /// re-sending.</remarks>
        ReliableInOrder = 48, // 0011 0000
        /// <summary>No reliability or sequentiality garantees, packet is sent and forgotten about.</summary>
