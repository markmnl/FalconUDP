...
namespace FalconUDP
{
    static class Settings
    {
        ...
        internal const int KeepAliveIfInterval                  = 10000;    
        internal const int KeepAliveIfNoKeepAliveReceived       = KeepAliveIfInterval + ACKTimeout + TickTime + 1;
        internal const int AutoFlushInterval                    = ACKTimeout - TickTime - 1;
